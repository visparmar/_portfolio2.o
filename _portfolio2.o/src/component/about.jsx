...
let json = {
  "about": {
    ...
    "intro": {
      "heading": "A Full Stack Developer with a Passion for Innovation",
      "description": "I'm Vikas Parmar, a full-stack web developer with 1.3 years of experience specializing in React for frontend development and Node.js for backend services. I’m driven by a love for building dynamic, efficient, and responsive web applications that solve real-world challenges."
    },
    "skills": {
    ...
    "experience": {
      "heading": "Experience",
      "description": "Over the past year and more, I've developed several full-stack projects, including e-commerce platforms, real-time chat applications, and market research tools. My strength lies in designing systems that balance functionality and user experience while ensuring scalable backend architectures."
    },
    "approach": {
      "heading": "My Approach",
      "description": "I’m passionate about continuous learning and strive to stay updated with the latest trends and best practices in the web development world. My process is always centered on understanding the client’s needs, breaking down complex problems, and providing elegant, well-structured solutions."
    },
    "cta": {
